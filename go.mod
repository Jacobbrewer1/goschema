...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20180906040556-529c652955d8 // indirect
...
replace github.com/pingcap/tidb v2.0.7+incompatible => github.com/jacobbrewer1/tidb v0.0.0-20180920082240-115c345593be
